...
import { MdCancelPresentation, MdPending } from "react-icons/md"
...
function OrdersStatistcsForAdmin({ totalOrders, pendingOrders, proccessingOrders, deliveredOrders, cancelledOrders, returnedOrders }: OrdersProps) {
  return (
    <>
  <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-1 mt-5">
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 mt-5">
...
export default OrdersStatistcsForAdmin
