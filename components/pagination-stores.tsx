...
function PaginationStoresSection({ totalPages }: { totalPages: number }) {
      ...
      <div className="flex items-center gap-x-1">
        {paginationArray.map((page) => (
          ...
          >
            <button
              type="button"
              className={`min-h-[38px] min-w-[38px] flex justify-center items-center bg-gray-200 text-gray-800 py-2 px-3 text-sm rounded-lg focus:outline-none disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-600 dark:text-white dark:focus:bg-gray-500 ${
                currentPage === page ? "bg-slate-950 text-white font-bold" : ""
              }`}
            >
              {page}
            </button>
...
export default PaginationStoresSection;
